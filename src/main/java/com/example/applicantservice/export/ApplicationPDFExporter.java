package com.example.applicantservice.export;
...
public class ApplicationPDFExporter {
	private List<ApplicantResponseDto> applicationList;
	...
	public void writeTableData(PdfPTable table) throws IOException {
		...
		for (ApplicantResponseDto applicationList : applicationList) {
	...
	public void export(HttpServletResponse response) throws DocumentException, IOException {
		...
		table.setWidths(new float[] { 2.5f, 1.5f, 2.0f, 2.5f, 2f, 2f });
